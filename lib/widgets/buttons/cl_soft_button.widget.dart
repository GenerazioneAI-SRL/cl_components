    ...
    return SizedBox(
      ...
      child: widget.text.isNotEmpty
          ...
          : IconButton(
              ...
              iconSize: iconSz,
              style: ButtonStyle(
                backgroundColor: WidgetStateProperty.all(widget.color.withValues(alpha: Sizes.opacity)),
                foregroundColor: WidgetStateProperty.all(widget.color),
                overlayColor: WidgetStateProperty.all(widget.color.withValues(alpha: 0.12)),
