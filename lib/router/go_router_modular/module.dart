import 'package:genai_components/router/go_router_modular/cl_path_utils.dart';
...
import 'package:genai_components/router/go_router_modular/routes/cl_route.dart';
import 'package:genai_components/router/go_router_modular/routes/modular_route.dart';
...
import 'package:genai_components/router/go_router_modular/transition.dart';
...
abstract class Module {
  ...
  List<GoRoute> _createChildRoutes({
    ...
    return source
        ...
        .where((route) => !CLPathUtils.isRootRoute(route.path))
  ...
  GoRoute _createChild({
    ...
    final String fullPath = CLPathUtils.normalizePath(
