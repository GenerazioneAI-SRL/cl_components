...
typedef OnChatButtonTap = void Function(
    AiChatMessage message, ChatButton button, int buttonIndex);
...
class ChatBubble extends StatelessWidget {
          ...
          if (message.isVoice)
            Padding(
              ...
              child: Icon(
                Icons.mic,
                size: 11,
                color: _isUser ? Colors.white54 : _textD.withValues(alpha: 0.5),
              ),
            ),
          if (_hasRichContent)
  ...
  Widget _richButtonsOutside() {
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [for (final block in buttonBlocks) _renderButtons(block)],
      ),
    );
  }
        ...
        children: [
          ...
          Flexible(
            child: Text(
              ...
              style: TextStyle(
                fontSize: 10,
                color: _textD.withValues(alpha: 0.7),
              ),
            ),
          ),
        ],
