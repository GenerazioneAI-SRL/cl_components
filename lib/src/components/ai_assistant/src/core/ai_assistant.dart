...
class _AiAssistantScope extends InheritedNotifier<GenaiAiAssistantController> {
  const _AiAssistantScope({
    required GenaiAiAssistantController controller,
...
///
/// Wrap your app's root (or any subtree) with [GenaiAiAssistant] to get:
...
/// )
/// ```
class GenaiAiAssistant extends StatefulWidget {
  /// Configuration for the AI assistant.
  final GenaiAiAssistantConfig config;
  ...
  static GenaiAiAssistantController read(BuildContext context) {
    final scope = context.getInheritedWidgetOfExactType<_AiAssistantScope>();
    assert(
      scope != null,
      'GenaiAiAssistant.read() called outside of GenaiAiAssistant widget tree.',
    );
    return scope!.notifier!;
  }

  @override
  State<GenaiAiAssistant> createState() => _AiAssistantState();
}

class _AiAssistantState extends State<GenaiAiAssistant> {
  late GenaiAiAssistantController _controller;
  ...
  void initState() {
    super.initState();
    _controller = GenaiAiAssistantController(
  ...
  @override
  void didUpdateWidget(GenaiAiAssistant oldWidget) {
    ...
    // listeners, which creates a fresh GenaiAiAssistantConfig with a new
...
class _DraggableFabArea extends StatefulWidget {
  final GenaiAiAssistantController controller;
  final GenaiAiAssistantConfig config;
