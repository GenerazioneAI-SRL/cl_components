...
/// ThemeExtension carrying all v2 design tokens.
///
/// Installed on [ThemeData] by `GenaiTheme.light` / `GenaiTheme.dark`. Read
/// via the `context.*` extensions (see `context_extensions.dart`).
@immutable
