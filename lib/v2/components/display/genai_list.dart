...
/// Vertical list container — v2 design system.
///
/// Stacks [children] top-to-bottom with optional dividers between rows and an
/// optional rounded bordered frame. Pure layout primitive — children supply
/// their own padding / interaction.
class GenaiList extends StatelessWidget {
  /// Rows rendered in order.
  final List<Widget> children;

  /// Whether to render a divider between rows. Defaults to `true`.
...
/// Single list row — v2 design system.
///
/// States handled: default, hover, selected, disabled (via `onTap == null`).
/// Uses `minTouchTarget` for a generous tap target and respects the hover
/// motion token.
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  widget.title,
                  style: ty.labelLg.copyWith(color: colors.textPrimary),
                ),
