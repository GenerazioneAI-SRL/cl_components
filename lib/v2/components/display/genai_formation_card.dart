...
/// Formation / training type card — v2 design system.
///
/// Domain card for LMS "formazione" grids. Mirrors the `.formation-card`
/// pattern in the reference HTML:
/// - 34×34 icon badge, `radius.lg`, [iconBg] tint, `textOnPrimary` glyph.
/// - name: `headingSm` primary.
/// - description: `bodySm` secondary, min 36 px height to align cards.
/// - footer row (space-between): optional hours (e.g. "24 ore", mono) +
///   linear progress percentage.
///
/// Card: `surfaceCard` bg, hairline border, `radius.lg`. Hover upgrades the
/// border to `borderStrong` and adds a layer-2 shadow when [onTap] is set.
