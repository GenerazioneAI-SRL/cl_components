...
class _CountBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final spacing = context.spacing;
    final radius = context.radius;
    final bg = danger ? colors.colorWarning : colors.surfaceCard;
    final fg = danger ? colors.textOnPrimary : colors.textPrimary;
    return Container(
      ...
      child: Text(
        '$count',
        style: ty.labelSm.copyWith(color: fg, fontWeight: FontWeight.w600),
      ),
    );
  }
}
