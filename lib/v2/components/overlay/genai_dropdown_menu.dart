...
/// Single entry inside a [GenaiDropdownMenu] — v2 design system.
...
/// Click-to-open dropdown menu (shadcn parity: `<DropdownMenu>`) — v2.
///
/// Distinct from [showGenaiContextMenu] (right-click): `GenaiDropdownMenu`
/// opens on **left-click of a trigger** and renders an anchored popover.
///
/// Features:
