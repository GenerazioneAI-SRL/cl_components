...
/// Shows a shadcn-style alert dialog — v2 design system (§6.5).
///
...
/// Locally-scoped button so the alert dialog has no v2-button dependency.
    ...
    return Semantics(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Text(
            label,
            style: ty.labelLg.copyWith(color: fg),
          ),
        ),
      ),
    );
