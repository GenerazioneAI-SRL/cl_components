...
/// Shows a modal dialog — v2 design system (§6.5).
///
/// Compact window sizes convert the modal to a bottom-sheet style (full
/// width, slide-up from bottom). Focus is trapped, `Esc` closes, and the
/// scrim uses `colors.scrimModal`.
    ...
    return Semantics(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Text(label, style: ty.labelLg.copyWith(color: fg)),
        ),
      ),
    );
  }
