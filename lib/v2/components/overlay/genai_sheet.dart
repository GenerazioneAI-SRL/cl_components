...
/// Edge that a [showGenaiSheet] slides in from — v2 design system.
///
...
/// Shows a side or edge sheet — the shadcn equivalent of `Sheet` (v2).
///
...
/// helper. Reduced motion is honoured automatically via v2's motion tokens.
///
