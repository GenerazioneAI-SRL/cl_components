...
/// Shows a context menu near [position] — v2 design system.
///
/// Returns the selected item's `value`, or null if dismissed.
                    ...
                    child: Row(
                      children: [
                        ...
                        if (item.shortcut != null)
                          Text(
                            item.shortcut!,
                            style: ty.labelSm.copyWith(color: c.textTertiary),
                          ),
                      ],
                    ),
                  ),
