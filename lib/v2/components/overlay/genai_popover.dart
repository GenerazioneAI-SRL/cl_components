...
// ignore: unused_import — referenced in doc comments for z-index mapping.
...
/// Anchored popover — v2 design system.
///
/// Wraps an anchor [child] and shows [content] in an overlay when tapped.
/// Closes on outside tap or `Esc`. Callers holding a `GlobalKey<GenaiPopoverState>`
/// can drive the popover imperatively via `show / hide / toggle`.
class GenaiPopover extends StatefulWidget {
  ...
  /// Interior padding. Defaults to `context.spacing.s12`.
...
class GenaiPopoverState extends State<GenaiPopover> {
  ...
  void show() {
    ...
    final effectivePadding = widget.padding ?? EdgeInsets.all(spacing.s12);
