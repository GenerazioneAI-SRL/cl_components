...
/// Single command listed inside a palette. Items are matched by [title],
/// [subtitle] and [keywords] against the live search query.
@immutable
class GenaiCommand {
  /// Stable id — useful for analytics / telemetry.
  final String id;
  ...
  /// Optional group header (e.g. `Navigation`, `Actions`).
  final String? group;
