...
class GenaiStepperStep {
  ...
  /// When true the step is drawn with danger tokens and an alert icon.
  final bool hasError;
...
/// Stepper / wizard — v2 design system.
///
/// Horizontal default: indicators laid on a connecting rail.
/// Vertical: stacked indicators with side copy.
/// Completed steps use `colorPrimary`; the active step is filled; upcoming
/// steps use `borderDefault`; errored steps use `colorDanger`.
class GenaiStepper extends StatelessWidget {
  ...
  /// Fires when the user taps a step indicator. Only completed or the current
  /// step should normally be interactive; the callback is wired for any step.
  final ValueChanged<int>? onStepTap;

  /// Accessibility override for the container.
...
/// Circular step indicator (completed / current / error / upcoming).
...
/// Text block rendered next to an indicator.
