...
/// Pagination control — v2 design system.
///
/// Renders: `< 1 ... 4 [5] 6 ... 20 >`. Both boundary neighbours and
/// sibling-radius around the current page are configurable. Disabled pages
/// degrade to muted, non-interactive chips. All cells meet
...
class GenaiPagination extends StatelessWidget {
  ...
  /// Fires with the new page index (1-based) when the user navigates.
  ...
  /// Accessibility override for the pagination region.
  ...
  /// Compute the compact page range with ellipsis placeholders.
  List<Object> _range() {
    final pages = <Object>[];
