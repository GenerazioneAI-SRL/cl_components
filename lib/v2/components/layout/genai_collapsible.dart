...
/// Single-panel expand/collapse — v2 design system (§6.3).
///
/// Unlike [GenaiAccordion], there is no grouping — this is a one-shot toggle.
/// Animates body via [AnimatedSize] using `context.motion.expand`.
class GenaiCollapsible extends StatefulWidget {
  ...
  /// When true, renders a thin border + md radius around the entire
  ...
  Widget build(BuildContext context) {
    ...
    final header = Container(
      ...
      padding: EdgeInsets.symmetric(
        horizontal: widget.bordered ? spacing.s16 : spacing.s0,
        vertical: spacing.s8,
      ),
