...
/// Multi-item accordion — v2 design system (§6.3).
///
/// Keyboard: Up/Down moves focus between headers, Enter/Space toggles, Home
/// jumps to first, End to last. Uses `context.motion.expand` for animation.
