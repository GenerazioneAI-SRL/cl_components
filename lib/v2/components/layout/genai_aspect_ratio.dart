...
/// Constrains a child to a fixed aspect ratio inside a themed surface
/// placeholder — v2 design system.
///
/// Unlike Flutter's [AspectRatio], this widget paints a subtle border +
/// rounded corners matching the v2 card aesthetic, and exposes slots for
...
class GenaiAspectRatio extends StatelessWidget {
  ...
  /// When true, wraps the child in a themed border + md radius.
  final bool bordered;
