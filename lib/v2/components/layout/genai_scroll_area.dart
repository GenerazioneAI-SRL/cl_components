...
/// Thin themed scrollbar wrapper — v2 design system (§6.3).
///
/// Renders a 2 px idle thumb that expands to 8 px on hover, fades after 1 s
/// of idle time. Pass a scrollable child; if none is provided, a
/// [SingleChildScrollView] is composed around [child].
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: RawScrollbar(
        ...
        thumbColor: _hovered ? colors.borderStrong : colors.borderDefault,
