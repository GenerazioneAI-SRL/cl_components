...
/// Two-panel split with a draggable divider — v2 design system (§6.3).
///
/// Ratio is tracked as the fraction of the **first** pane (0..1).
/// Keyboard: when the divider is focused, arrow keys move the split by 5%.
        ...
        child: MouseRegion(
          ...
          child: GestureDetector(
            ...
            onVerticalDragUpdate: !horizontal
                ...
                : null,
            child: SizedBox(
              width: horizontal ? sizing.minTouchTarget / 4 : null,
              height: horizontal ? null : sizing.minTouchTarget / 4,
