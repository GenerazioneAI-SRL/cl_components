...
/// Error state placeholder — v2 design system (§6.4).
///
/// Used on screens that fail to load. Always includes a retry affordance
/// where possible. Live region announces on mount.
class GenaiErrorState extends StatelessWidget {
  /// Heading. Typically a short sentence ("Something went wrong").
  final String title;
  ...
  /// Optional secondary action (typically "Contact support").
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  title,
                  style: ty.headingMd.copyWith(color: colors.textPrimary),
