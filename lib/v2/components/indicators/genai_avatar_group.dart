...
/// Stack of overlapping avatars with `+N` overflow — v2 design system (§6.7.5).
///
/// Ring color around each avatar matches `surfaceCard` so the group reads
/// cleanly on any surface layer.
