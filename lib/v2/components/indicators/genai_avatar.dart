...
/// User avatar with image / initials / placeholder fallback — v2 design
/// system (§6.7.4).
///
/// Three modes via named constructors:
/// - [GenaiAvatar.image] — loads from a URL.
...
class GenaiAvatar extends StatelessWidget {
  ...
  /// Deterministic background color seeded from [key]. Uses the semantic
  /// palette so the selection stays theme-aware.
