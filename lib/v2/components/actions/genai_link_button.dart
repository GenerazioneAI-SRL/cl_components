...
/// Inline clickable text styled as a link — v2 design system (§6.2.6).
///
/// Underlines on hover, uses `textLink` color. Always rendered inline with the
/// surrounding text unless [size] is set to promote it.
