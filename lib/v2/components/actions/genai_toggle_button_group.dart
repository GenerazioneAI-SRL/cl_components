...
/// Single-select segmented group — v2 design system (§6.2.3).
///
...
/// Multi-select segmented group — v2 design system (§6.2.3).
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < options.length; i++) {
      ...
      final borderRadius = BorderRadius.horizontal(
        ...
        right: Radius.circular(i == options.length - 1 ? radius : 0),
      );
    ...
    final group = Container(
      decoration: BoxDecoration(
        border: Border.all(color: colors.borderDefault, width: divider),
