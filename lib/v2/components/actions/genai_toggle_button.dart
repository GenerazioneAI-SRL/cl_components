...
/// Visual variant of a [GenaiToggleButton] — v2 design system (§6.2.3).
...
/// Single pressable toggle — v2 design system (§6.2.3).
///
...
///
/// Distinct from `GenaiToggle` (switch-style) — this is a stateful button,
/// not a binary setting.
...
class _GenaiToggleButtonState extends State<GenaiToggleButton> {
  ...
  Widget build(BuildContext context) {
    ...
    // Hover/press overlay (ghost-style) while unpressed; pressed stays accent.
    if (!_disabled) {
      if (_pressing) {
        bg = widget.pressed
