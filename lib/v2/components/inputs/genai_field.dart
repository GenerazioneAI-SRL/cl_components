...
/// Composable form-field wrapper (shadcn parity: `<Field>`) — v2 design system.
///
...
///   [isDisabled])
/// - `spacing.s4` gap (matches the v2 `_FieldFrame` cadence)
/// - [child]
...
class GenaiField extends StatelessWidget {
  ...
  /// error visible. Turn off for inline fields where the empty space below
  ...
  Widget build(BuildContext context) {
    ...
    final labelStyle = ty.labelMd.copyWith(color: labelColor);
