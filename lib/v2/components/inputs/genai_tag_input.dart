...
/// Chips-style input — user types a value, presses Enter or a separator
/// character, and it commits to the [values] list as a removable chip.
///
/// * Backspace in an empty editor removes the last chip.
/// * [separators] can include `,` and `;` to split on paste.
class GenaiTagInput extends StatefulWidget {
  ...
  /// Callback to validate/transform an incoming tag before it is appended.
  /// Return null to reject it.
      ...
      child: IntrinsicWidth(
        child: ConstrainedBox(
          ...
          child: TextField(
            ...
            onChanged: (v) {
              // Commit on separator characters as the user types.
              for (final sep in widget.separators) {
                if (v.contains(sep)) {
                  _commit(v);
                  return;
