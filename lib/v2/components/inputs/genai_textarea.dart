...
/// Multiline text input with optional autoGrow.
///
/// Similar to multiline `GenaiTextField` in v1 but as its own component with
/// v2 chrome. When [autoGrow] is `true` the textarea expands between
/// [minLines] and [maxLines] as the user types; otherwise it scrolls
...
class GenaiTextarea extends StatefulWidget {
  ...
  /// Append a red asterisk after [label].
  ...
  Widget build(BuildContext context) {
    ...
    final control = AnimatedContainer(
      ...
      child: TextField(
        ...
        maxLines: widget.autoGrow
            ? widget.maxLines
            : widget.minLines, // scroll inside fixed box
