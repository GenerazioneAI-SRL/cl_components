...
/// Logical window-size buckets — v2 design system.
///
/// Layout decisions always key off window **width**, never [Platform]. The
/// breakpoints match v1 for cross-compatibility of showcase pages that render
...
class GenaiResponsive {
  ...
  ///
  /// v2 components should collapse all [GenaiMotion] durations to
  /// [Duration.zero] when this is true (§3.6).
