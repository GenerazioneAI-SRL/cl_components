/// Global z-index / layering tokens — v2 design system.
///
/// Mirror of the v1 scale (re-declared in the v2 namespace so consumers
/// using `import as v2;` don't cross-reference the v1 library).
class GenaiZIndex {
  GenaiZIndex._();
