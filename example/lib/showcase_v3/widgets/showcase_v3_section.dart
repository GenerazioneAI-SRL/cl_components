...
class ShowcaseV3Scaffold extends StatelessWidget {
  final List<Widget> children;
  final String? title;
  final String? description;

  const ShowcaseV3Scaffold({
    super.key,
...
class ShowcaseV3Section extends StatelessWidget {
  final String title;
  final String? subtitle;
  final Widget child;

  const ShowcaseV3Section({
    super.key,
    required this.title,
    required this.child,
    this.subtitle,
...
class ShowcaseV3Row extends StatelessWidget {
  final String label;
  final List<Widget> children;
