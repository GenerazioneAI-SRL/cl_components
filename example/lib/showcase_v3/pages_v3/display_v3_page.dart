...
class DisplayV3Page extends StatelessWidget {
  const DisplayV3Page({super.key});
    ...
    return ShowcaseV3Scaffold(
      ...
      children: [
        ...
        ShowcaseV3Section(
          ...
          child: ShowcaseV3Row(label: 'samples', children: [
              ...
              children: [
                GenaiListItem(
                    ...
                    trailing: GenaiChip.readonly(
                        label: 'In corso', tone: GenaiChipTone.info),
                    onTap: () {}),
                GenaiListItem(
                    leading: Icon(LucideIcons.book,
                        color: context.colors.textSecondary),
                    ...
                    trailing: GenaiChip.readonly(
                        label: 'Completato', tone: GenaiChipTone.ok),
                    onTap: () {}),
                GenaiListItem(
                    ...
                    trailing: GenaiChip.readonly(
                        label: 'Bloccato', tone: GenaiChipTone.neutral),
                    onTap: () {}),
              ],
            ),
          ),
          ...
          child: SizedBox(
            ...
            child: GenaiKanban<String>(
              columns: const [
                ...
                GenaiKanbanColumn(
                    id: 'done', title: 'Completati', items: ['Onboarding']),
              ],
        ...
        ShowcaseV3Section(
          title: 'Table',
          subtitle: 'GenaiTable gestisce sort / filter / pagination '
