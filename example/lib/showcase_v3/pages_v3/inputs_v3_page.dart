...
class InputsV3Page extends StatefulWidget {
  const InputsV3Page({super.key});

  @override
  State<InputsV3Page> createState() => _InputsV3PageState();
}

class _InputsV3PageState extends State<InputsV3Page> {
  bool _cb = false;
  ...
  Widget build(BuildContext context) {
    return ShowcaseV3Scaffold(
      ...
      children: [
        ShowcaseV3Section(
          title: 'Text field',
          subtitle: 'outline (default) / filled / ghost. States disabled/error.',
          child: Column(
            ...
            children: [
              ...
              GenaiTextField.password(
                  label: 'Password', hintText: 'min 8 caratteri'),
              SizedBox(height: context.spacing.s12),
        ...
        ShowcaseV3Section(
          ...
          child: const ShowcaseV3Row(label: 'variants', children: [
          ...
          child: Column(
            ...
            children: [
              GenaiSelect<String>(
                ...
                options: const [
                  GenaiSelectOption(
                      value: 'obbligatoria', label: 'Obbligatoria'),
              ...
              GenaiCombobox<String>(
                ...
                options: const [
                  GenaiSelectOption(
                      value: 'sec', label: 'Sicurezza e guardrail'),
                  GenaiSelectOption(
                      value: 'pri', label: 'Privacy 2026'),
                  GenaiSelectOption(
                      value: 'aml', label: 'Antiriciclaggio'),
                  GenaiSelectOption(
                      value: 'aif', label: 'AI per il business'),
                ],
                onChanged: (_) {},
              ),
            ],
