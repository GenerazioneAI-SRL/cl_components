...
class LayoutV3Page extends StatelessWidget {
  const LayoutV3Page({super.key});
        ...
        ShowcaseV3Section(
          ...
          child: GenaiCard.outlined(
            child: GenaiSection(
              ...
              trailing:
                  GenaiLinkButton(label: 'Vedi tutti', onPressed: () {}),
              divider: true,
              child: Text('Contenuto di sezione.',
                  style:
                      ty.bodySm.copyWith(color: colors.textSecondary)),
            ),
          ),
            ...
            children: [
              SizedBox(
                  ...
                  child: GenaiAspectRatio(
                      ratio: 16 / 9, bordered: true)),
              SizedBox(width: context.spacing.s12),
              SizedBox(
                  width: 200,
                  child: GenaiAspectRatio(
                      ratio: 4 / 3, bordered: true)),
              SizedBox(width: context.spacing.s12),
              SizedBox(
                  width: 120,
