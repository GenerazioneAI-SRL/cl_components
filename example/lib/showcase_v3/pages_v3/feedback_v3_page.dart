...
class FeedbackV3Page extends StatelessWidget {
  const FeedbackV3Page({super.key});
    ...
    return ShowcaseV3Scaffold(
      ...
      children: [
        ...
        ShowcaseV3Section(
          ...
          child: Column(children: [
            ShowcaseV3Row(label: 'variants', children: [
              GenaiToast(
            ...
            ShowcaseV3Row(label: 'danger', children: [
              GenaiToast(
        ...
        ShowcaseV3Section(
          ...
          child: const ShowcaseV3Row(label: 'sizes', children: [
        ...
        ShowcaseV3Section(
          ...
          child: Column(
            ...
            children: [
              const SizedBox(
                  height: 10,
                  child: GenaiProgressBar(value: 0.35, tone: GenaiProgressBarTone.ink)),
              SizedBox(height: context.spacing.s12),
              const SizedBox(
                  height: 10,
                  child: GenaiProgressBar(value: 0.65, tone: GenaiProgressBarTone.info)),
              SizedBox(height: context.spacing.s12),
              const SizedBox(
                  height: 10,
                  child: GenaiProgressBar(value: 0.90, tone: GenaiProgressBarTone.ok)),
              SizedBox(height: context.spacing.s12),
              const SizedBox(
                  height: 10,
                  child: GenaiProgressBar(value: 0.25, tone: GenaiProgressBarTone.warn)),
              SizedBox(height: context.spacing.s12),
              const SizedBox(
                  height: 10,
                  child: GenaiProgressBar(value: 0.15, tone: GenaiProgressBarTone.danger)),
              SizedBox(height: context.spacing.s12),
              const SizedBox(
                  height: 10,
                  child: GenaiProgressBar()), // indeterminate
            ],
          ),
        ),
        ShowcaseV3Section(
          ...
          child: const ShowcaseV3Row(label: 'values', children: [
        ...
        ShowcaseV3Section(
          ...
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 8),
              GenaiSkeleton(
                  width: 32, height: 32, shape: GenaiSkeletonShape.circle),
              SizedBox(height: 8),
              GenaiSkeleton(
                  width: 80, height: 24, shape: GenaiSkeletonShape.pill),
            ],
          ),
        ),
        ShowcaseV3Section(
              ...
              GenaiCard.outlined(
                child: GenaiEmptyState(
                  ...
                  primaryAction: GenaiButton.primary(
                      label: 'Vai al dashboard', onPressed: () {}),
                ),
              ),
